<footer class="footer p-10 bg-neutral text-neutral-content grid place-items-center">

        <img src="potenseeklogo.png" alt="Potenseek Logo" class="h-14 aspect-auto">

        <div class="grid grid-flow-col gap-4">
            <a class="flex items-center"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" id="email"
                    class="w-8">
                    <path fill="#222"
                ...
                </svg> potenseekid@gmail.com</a>
            <a class="flex items-center"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-8"
                    id="instagram">
                    <path
        ...
        <div>© PotenSeek, Surabaya, Indonesia</div>
